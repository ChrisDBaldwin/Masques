...
pub fn build(b: *std.Build) void {
    ...
    // DuckDB driver dependency (uses system libduckdb from Homebrew)
    ...
    const exe = b.addExecutable(.{
        ...
        .root_module = b.createModule(.{
            ...
            // root module.
            .imports = &.{
                // Here "masque" is the name you will use in your source code to
                // import this module (e.g. `@import("masque")`). The name is
